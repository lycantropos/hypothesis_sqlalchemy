...
@given(
    strategies.tables_with_fixed_columns_values,
...
def test_basic(
    ...
    result = table_records_lists(
        table, min_size=min_size, max_size=max_size, **fixed_columns_values
    )
